...
`;let gt=class extends ce{constructor(){super(...arguments),this._message="",this._visible=!1}show(e){this._clearTimer(),this._message=e,this._visible=!0,this._timer=window.setTimeout(()=>{this._visible=!1,this._timer=void 0},2700)}disconnectedCallback(){super.disconnectedCallback(),this._clearTimer()}_clearTimer(){void 0!==this._timer&&(window.clearTimeout(this._timer),this._timer=void 0)}render(){return this._message?B`
  ...
  `,e([me({type:String})],bt.prototype,"heading",void 0),e([me({type:String})],bt.prototype,"subheading",void 0),e([me({attribute:!1})],bt.prototype,"items",void 0),e([me({type:Boolean})],bt.prototype,"open",void 0),bt=e([pe("chorus-menu")],bt);let vt=class extends ce{constructor(){super(...arguments),this.heading="",this.subheading="",this.controls=[],this.open=!1,this._onKeyDown=e=>{this.open&&"Escape"===e.key&&(e.stopPropagation(),this._close())}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._onKeyDown)}disconnectedCallback(){window.removeEventListener("keydown",this._onKeyDown),super.disconnectedCallback()}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}_onBackdrop(e){e.target===e.currentTarget&&this._close()}_emit(e,t){this.dispatchEvent(new CustomEvent("change",{detail:{id:e,value:t},bubbles:!0,composed:!0}))}_grouped(){const e=[],t=new Map;for(const r of this.controls){const o=r.group;t.has(o)||(t.set(o,[]),e.push(o)),t.get(o).push(r)}return e.map(e=>({group:e,rows:t.get(e)}))}_pct(e){const t=e.min??0,r=e.max??100,o="number"==typeof e.value?e.value:0;if(r===t)return 0;return(Math.min(r,Math.max(t,o))-t)/(r-t)*100}_fill(e){return`linear-gradient(90deg, var(--primary-color) ${e}%, var(--divider-color) ${e}%)`}_formatValue(e){const t="number"==typeof e.value?e.value:0;return e.format?`${t}${e.format}`:`${t}`}_onSlider(e,t){const r=t.target,o=Number(r.value),s=e.min??0,i=e.max??100,a=i===s?0:(o-s)/(i-s)*100;r.style.background=this._fill(a);const n=r.closest(".aset-row")?.querySelector(".rv");n&&(n.textContent=e.format?`${o}${e.format}`:`${o}`),this._emit(e.id,o)}_onToggle(e,t){const r=t.target;this._emit(e.id,r.checked)}_sliderRow(e){const t=this._pct(e),r="number"==typeof e.value?e.value:0;return B`
  ...
  `,e([me({type:String})],vt.prototype,"heading",void 0),e([me({type:String})],vt.prototype,"subheading",void 0),e([me({attribute:!1})],vt.prototype,"controls",void 0),e([me({type:Boolean})],vt.prototype,"open",void 0),vt=e([pe("chorus-audio")],vt);const ft=[{key:"bass",label:"Bass",group:"EQ"},{key:"treble",label:"Treble",group:"EQ"},{key:"loudness",label:"Loudness",group:"EQ",toggle:!0},{key:"sub_gain",label:"Sub level",group:"Surround & sub"},{key:"subwoofer_enabled",label:"Subwoofer",group:"Surround & sub",toggle:!0},{key:"surround_level",label:"Surround level",group:"Surround & sub"},{key:"surround_enabled",label:"Surround",group:"Surround & sub",toggle:!0},{key:"night_sound",label:"Night sound",group:"TV audio",toggle:!0},{key:"speech_enhancement",label:"Speech enhancement",group:"TV audio",toggle:!0},{key:"audio_delay",label:"Audio delay",group:"TV audio"},{key:"crossfade",label:"Crossfade",group:"Playback",toggle:!0},{key:"balance",label:"Balance",group:"Playback"}],xt="chorus:fixed_output",yt="chorus:volume",_t={LF:"t-front",RF:"t-front",LR:"t-rear",RR:"t-rear",SW:"t-sub"};let wt=class extends ce{constructor(){super(...arguments),this.narrow=!1,this._dirty=!1,this._applying=!1,this._rows=[],this._settleView=null,this._releasedUids=[],this._settleTimedOut=!1,this._vol={},this._syncOverlayCentre=()=>{const e=this.getBoundingClientRect();e.width&&this.style.setProperty("--chorus-bar-left",`${Math.round(e.left+e.width/2)}px`)},this._onMenuSelect=e=>{const t=this._menu;this._menu=void 0,t?.onSelect(e.detail)},this._onAudioChange=e=>{const{id:t,value:r}=e.detail;if(t.startsWith(`${yt}:`))this._setVolume(t.slice(14),Number(r));else if(t.startsWith(`${xt}:`)){const e=t.slice(20);this.hass.callService("chorus","set_fixed_output",{speaker:e,enabled:!!r})}else"boolean"==typeof r?this.hass.callService("switch",r?"turn_on":"turn_off",{entity_id:t}):this.hass.callService("number","set_value",{entity_id:t,value:r});this._audio&&(this._audio={...this._audio,controls:this._audio.controls.map(e=>e.id===t?{...e,value:r}:e)})}}connectedCallback(){super.connectedCallback(),this._syncOverlayCentre(),this._ro=new ResizeObserver(()=>this._syncOverlayCentre()),this._ro.observe(this),window.addEventListener("resize",this._syncOverlayCentre)}disconnectedCallback(){this._ro?.disconnect(),window.removeEventListener("resize",this._syncOverlayCentre),super.disconnectedCallback()}willUpdate(e){(e.has("graph")&&!this._dirty||void 0===this._working)&&(this._working=structuredClone(Pe(this.graph))),e.has("graph")&&(this._vol={}),e.has("selectRoom")&&this.selectRoom&&(this._selected=this.selectRoom)}get _rooms(){return this._working??Pe(this.graph)}_room(){const e=this._rooms.filter(e=>e.key!==Ee);if(this._selected){const t=e.find(e=>e.key===this._selected);if(t)return t}return this.narrow?void 0:e[0]}_availableSubs(){return this._rooms.find(e=>e.key===Ee)?.tray??[]}_plan(){return nt(Fe(Pe(this.graph)),Fe(this._rooms))}_toast(e){const t=this.shadowRoot?.querySelector("chorus-toast");t?.show(e)}_assign(e,t,r,o){this._working=function(e,t,r,o,s){const i=He(e),a=je(i,t),n=De(a,r);if(!a||!n)return i;const l=a.tray.findIndex(e=>e.uid===s);if(-1===l)return i;const[c]=a.tray.splice(l,1),d=n.slots[o];return d&&Ge(i,a,o,d),n.slots[o]=c,a.tray.sort(Ie),i}(this._rooms,e,t,r,o.uid),this._dirty=!0,this._picker=void 0,this._toast(`${this._name(o)} → ${ve[r]}`)}_assignSub(e,t,r){const o=this._availableSubs().find(e=>e.uid===r);this._working=function(e,t,r,o){const s=He(e),i=je(s,t),a=De(i,r);if(!i||!a)return s;let n;const l=s.find(e=>e.key===Ee);if(l){const e=l.tray.findIndex(e=>e.uid===o);e>=0&&(n=l.tray.splice(e,1)[0])}if(!n)e:for(const e of s)for(const t of e.sets)if(t.slots.SW?.uid===o){n=t.slots.SW,delete t.slots.SW;break e}if(!n)return s;const c=a.slots.SW;return c&&Ke(s,c),a.slots.SW=n,Be(s)}(this._rooms,e,t,r),this._dirty=!0,this._picker=void 0,this._toast(o?`${this._name(o)} → ${ve.SW}`:"Sub added")}_canDrop(e,t){return!!this._drag&&(this._drag.roomKey===Ee?"SW"===t&&$e("SW",this._drag.model):this._drag.roomKey===e.key&&$e(t,this._drag.model))}_dropOnChannel(e,t,r){if(!this._canDrop(e,r))return;const o=this._drag;if(this._drag=void 0,o.roomKey===Ee)this._assignSub(e.key,t,o.uid);else{const s=e.tray.find(e=>e.uid===o.uid);s&&this._assign(e.key,t,r,s)}}_onDragOver(e,t,r){this._canDrop(t,r)&&(e.preventDefault(),e.currentTarget.classList.add("over"))}_onDrop(e,t,r,o){e.preventDefault(),e.currentTarget.classList.remove("over"),this._dropOnChannel(t,r,o)}_clear(e,t,r,o){this._working=Qe(this._rooms,e,t,r),this._dirty=!0,this._toast(`${o.name} removed from ${ve[r]}`)}_separate(e,t){this._working=Ye(this._rooms,e,t),this._dirty=!0,this._toast("Stereo pair separated")}_pickPairMember(e){if(!this._pairPick)return;const{roomKey:t,first:r}=this._pairPick;r?e.uid!==r&&(this._working=function(e,t,r,o){const s=He(e),i=je(s,t);if(!i||r===o)return s;const a=i.tray.findIndex(e=>e.uid===r),n=i.tray.findIndex(e=>e.uid===o);if(-1===a||-1===n)return s;const l=i.tray[a],c=i.tray[n];return i.tray=i.tray.filter(e=>e.uid!==r&&e.uid!==o),i.sets.push({id:l.uid,name:qe(i),volume:l.volume??null,primary:l,slots:{RF:c}}),s}(this._rooms,t,r,e.uid),this._dirty=!0,this._pairPick=void 0,this._toast("Stereo pair created")):this._pairPick={roomKey:t,first:e.uid}}_openRoomMenu(e,t){this._menu={heading:e.name,items:[{id:"audio",label:"Audio settings"},{id:"dissolve",label:"Separate home theater",danger:!0}],onSelect:r=>{"audio"===r?this._openAudio(this._setName(t),t.primary.uid):"dissolve"===r&&(this._working=function(e,t,r){const o=He(e),s=je(o,t);if(!s)return o;const i=s.sets.findIndex(e=>e.id===r);if(-1===i)return o;const[a]=s.sets.splice(i,1);for(const e of be){const t=a.slots[e];t&&Ge(o,s,e,t)}return Ve(s,a.primary),Be(o)}(this._rooms,e.key,t.id),this._dirty=!0,this._toast("Home theater separated"))}}}_openPairMenu(e,t){const r=!!t.slots.SW?[{id:"audio",label:"Audio settings"},{id:"rename",label:"Rename"},{id:"removesub",label:"Remove sub"}]:[{id:"audio",label:"Audio settings"},{id:"rename",label:"Rename"},{id:"addsub",label:"Add a sub"},{id:"swap",label:"Swap L / R"},{id:"separate",label:"Separate pair",danger:!0}];this._menu={heading:"Stereo pair",items:r,onSelect:r=>{"audio"===r?this._openAudio(this._setName(t),t.primary.uid):"rename"===r?this._renameFor={uid:t.primary.uid,current:this._setName(t)}:"addsub"===r?this._availableSubs().length?this._picker={roomKey:e.key,setId:t.id,ch:"SW"}:this._toast("No available sub"):"removesub"===r?(this._working=Qe(this._rooms,e.key,t.id,"SW"),this._dirty=!0,this._toast("Sub removed")):"swap"===r?(this._working=function(e,t,r){const o=He(e),s=De(je(o,t),r);if(!s||!s.slots.RF)return o;const i=s.primary;return s.primary=s.slots.RF,s.slots.RF=i,s.id=s.primary.uid,o}(this._rooms,e.key,t.id),this._dirty=!0,this._toast("Swapped L / R")):"separate"===r&&this._separate(e.key,t.id)}}}_openSpeakerMenu(e,t){const r=[{id:"identify",label:"Identify"},{id:"audio",label:"Audio settings"}];!_e(e.model)&&this._availableSubs().length>0&&r.push({id:"addsub",label:"Add a sub"}),r.push({id:"rename",label:"Rename"},{id:"move",label:"Move to another room"}),this._menu={heading:this._name(e),items:r,onSelect:r=>{if("identify"===r)this._identify(e);else if("audio"===r)this._openAudio(this._name(e),e.uid);else if("addsub"===r){const r=this._availableSubs()[0];r&&(this._working=function(e,t,r,o){const s=He(e),i=je(s,t);if(!i)return s;const a=i.tray.findIndex(e=>e.uid===r);if(-1===a)return s;let n;const l=s.find(e=>e.key===Ee);if(l){const e=l.tray.findIndex(e=>e.uid===o);e>=0&&(n=l.tray.splice(e,1)[0])}if(!n)e:for(const e of s)for(const t of e.sets)if(t.slots.SW?.uid===o){n=t.slots.SW,delete t.slots.SW;break e}if(!n)return s;const[c]=i.tray.splice(a,1);return i.sets.push({id:c.uid,name:c.name,volume:c.volume??null,primary:c,slots:{SW:n}}),Be(s)}(this._rooms,t,e.uid,r.uid),this._dirty=!0,this._toast(`${this._name(r)} → ${ve.SW}`))}else"rename"===r?this._renameFor={uid:e.uid,current:this._name(e)}:"move"===r&&(this._movePick=e.uid)}}}_openSpeakerSetMenu(e,t){this._menu={heading:this._setName(t),items:[{id:"removesub",label:"Remove sub"}],onSelect:r=>{"removesub"===r&&(this._working=Ye(this._rooms,e.key,t.id),this._dirty=!0,this._toast("Sub removed"))}}}_doRename(){const e=this.shadowRoot?.querySelector(".rename-input"),t=e?.value.trim(),r=this._renameFor;this._renameFor=void 0,r&&t&&t!==r.current&&(this._working=function(e,t,r){const o=He(e);for(const e of o){for(const s of e.tray)if(s.uid===t)return s.name=r,o;for(const s of e.sets){if(s.primary.uid===t)return s.name=r,o;for(const e of be){const i=s.slots[e];if(i?.uid===t)return s.name=r,o}}}return o}(this._rooms,r.uid,t),this._dirty=!0,this._toast(`Rename to ${t}`))}_renameOverlay(){return this._renameFor?B`
    ...
    `}_hassReg(){return this.hass}_deviceIdFor(e){if(!e)return;const{devices:t}=this._hassReg();for(const[r,o]of Object.entries(t??{}))if(o.identifiers?.some(t=>"sonos"===t[0]&&t[1]===e))return r}_speakerEntityIds(e,t){const{entities:r,states:o}=this._hassReg(),s=this._deviceIdFor(e);if(s&&r)return Object.entries(r).filter(([,e])=>e.device_id===s).map(([e])=>e);const i=(e=>e.toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,""))(t);return Object.keys(o??{}).filter(e=>e.includes(`.${i}_`))}async _identify(e){try{await this.hass.callService("chorus","identify",{speaker:e.uid}),this._toast(`Identifying ${this._name(e)}`)}catch(e){const t=e?.message;this._toast(t||"Couldn't identify this speaker — try again.")}}_setVolume(e,t){const r=Math.max(0,Math.min(100,Math.round(t)));this._vol={...this._vol,[e]:r},this.hass.callService("chorus","set_volume",{speaker:e,level:r})}_volumeSlider(e,t){const r=this._vol[e]??t??0;return B`
      <label class="vol" title="Volume" @click=${e=>e.stopPropagation()}>
        ...
        <input
          ...
          max="100"
          .value=${String(r)}
          @change=${t=>this._setVolume(e,Number(t.target.value))}
        />
        <span class="vol-num">${r}</span>
      </label>
    `}async _openAudio(e,t){const r=this._speakerEntityIds(t,e),o=[];for(const e of ft){const t=e.toggle?"switch":"number",s=r.find(r=>r.startsWith(`${t}.`)&&r.endsWith(`_${e.key}`)),i=s?this.hass?.states?.[s]:void 0;if(i&&s&&"unavailable"!==i.state&&"unknown"!==i.state)if(e.toggle)o.push({id:s,kind:"toggle",label:e.label,group:e.group,value:"on"===i.state});else{const t=i.attributes;o.push({id:s,kind:"slider",label:e.label,group:e.group,value:Number(i.state),min:t.min??0,max:t.max??100,step:t.step??1})}}if(t)try{const e=await this.hass.connection.sendMessagePromise({type:"chorus/output_fixed",speaker:t});e?.supported&&o.push({id:`${xt}:${t}`,kind:"toggle",label:"Fixed line-out volume",group:"Output",value:!!e.fixed})}catch{}t&&o.unshift({id:`${yt}:${t}`,kind:"slider",label:"Volume",group:"Volume",value:this._vol[t]??this._committedVolume(t)??0,min:0,max:100,step:1}),o.length?this._audio={heading:`${e} · Audio`,controls:o}:this._toast("No audio settings available for this speaker")}_committedVolume(e){const t=this.graph?.units?.find(t=>t.primary_uid===e);return t?.volume??null}_dots(e){return B`<button
      type="button"
      class="dots"
      title="Options"
      aria-label="Options"
    ...
    `}_htSet(e){return e.sets.find(e=>"home_theater"===Se(e))}_pairSets(e){return e.sets.filter(e=>"stereo_pair"===Se(e))}_speakerSets(e){return e.sets.filter(e=>"speaker"===Se(e))}_speakerSetCard(e,t){const r=t.slots.SW??null;return B`
      <div class="paircard">
        ...
        ${r?B`<span class="pc-sub"><span class="pc-sub-ic">${Te(r.model)}</span> Sub · ${r.name}</span>`:q}
        <span class="grow"></span>
        ${r?this._dots(()=>this._openSpeakerSetMenu(e,t)):q}
        ${this._volumeSlider(t.primary.uid,t.volume)}
      </div>
    ...
    `}_roomSummary(e){const t=[],r=this._htSet(e);if(r){const e=be.filter(e=>"SW"!==e&&r.slots[e]).length;t.push(`Home theater · ${e}.${r.slots.SW?"1":"0"}`)}const o=this._pairSets(e).length;o&&t.push(1===o?"Stereo pair":`${o} pairs`);const s=e.tray.length;return s&&!r&&t.push(1===s?"1 speaker":`${s} speakers`),t.join(" · ")||"No speakers"}_detail(e){const t=this._htSet(e),r=this._pairSets(e),o=this._speakerSets(e);return B`
      ...
      ${t?B`<div class="volrow">${this._volumeSlider(t.primary.uid,t.volume)}</div>`:q}
    ...
    `}_setupCta(e){const t=e.tray.find(e=>_e(e.model));return t?B`
      <button
        type="button"
        class="cta"
        @click=${()=>{this._working=function(e,t,r){const o=He(e),s=je(o,t);if(!s)return o;const i=s.tray.findIndex(e=>e.uid===r);if(-1===i)return o;const[a]=s.tray.splice(i,1);return s.sets.push({id:a.uid,name:a.name,volume:a.volume??null,primary:a,slots:{}}),o}(this._rooms,e.key,t.uid),this._dirty=!0,this._toast("Home theater created")}}
      >
    ...
    `}_pos(e,t,r){const o=t.slots[r],s="SW"===r?this._availableSubs().length>0:e.tray.some(e=>$e(r,e.model));if(!o){const o=()=>{s&&(this._picker={roomKey:e.key,setId:t.id,ch:r})};return B`
      ...
      <div
        ...
        @drop=${o=>this._onDrop(o,e,t.id,r)}
      >
        <span class="badge ${_t[r]}">${Te(o.model)}</span>
        <span class="pmeta">
    ...
    `}_pairCard(e,t){const r=t.primary,o=t.slots.RF??null,s=t.slots.SW??null;return B`
      <div class="paircard">
        ...
        ${s?B`<span class="pc-sub"><span class="pc-sub-ic">${Te(s.model)}</span> Sub · ${s.name}</span>`:q}
        <span class="grow"></span>
    ...
    `}_pcSlot(e,t){return B`
      <div class="pc-slot ${t?"":"empty"}">
        ${t?B`<span class="badge orb t-front">${Te(t.model)}</span>`:B`<span class="badge empty-badge">${e}</span>`}
    ...
    `}_speakerRow(e,t){return B`
      ...
      >
        ...
        ${t===Ee?q:this._volumeSlider(e.uid,e.volume)}
      </div>
  ...
  `,e([me({attribute:!1})],wt.prototype,"hass",void 0),e([me({attribute:!1})],wt.prototype,"graph",void 0),e([me({type:Boolean})],wt.prototype,"narrow",void 0),e([me({attribute:!1})],wt.prototype,"selectRoom",void 0),e([ge()],wt.prototype,"_selected",void 0),e([ge()],wt.prototype,"_working",void 0),e([ge()],wt.prototype,"_dirty",void 0),e([ge()],wt.prototype,"_applying",void 0),e([ge()],wt.prototype,"_rows",void 0),e([ge()],wt.prototype,"_settleView",void 0),e([ge()],wt.prototype,"_picker",void 0),e([ge()],wt.prototype,"_pairPick",void 0),e([ge()],wt.prototype,"_menu",void 0),e([ge()],wt.prototype,"_audio",void 0),e([ge()],wt.prototype,"_movePick",void 0),e([ge()],wt.prototype,"_renameFor",void 0),e([ge()],wt.prototype,"_vol",void 0),wt=e([pe("chorus-editor")],wt);const kt="none",$t="1.7",St=[{accent:"front",icon:B`<svg
  viewBox="0 0 24 24"
  fill=${kt}
  stroke="currentColor"
  stroke-width=${$t}
...
>
  ...
  <path d="M3.5 9.5h17" />
  <path d="M8.5 9.5v10" />
</svg>`,title:"Overview tab",text:"A read-only, at-a-glance view of everything currently bonded."}];let zt=class extends ce{constructor(){super(...arguments),this.open=!1,this._onKeyDown=e=>{this.open&&"Escape"===e.key&&(e.stopPropagation(),this._close())}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._onKeyDown)}disconnectedCallback(){window.removeEventListener("keydown",this._onKeyDown),super.disconnectedCallback()}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}_onBackdrop(e){e.target===e.currentTarget&&this._close()}render(){return this.open?B`
      <div class="backdrop" @click=${this._onBackdrop}>
        <div
          class="card"
          role="dialog"
  ...
  `,e([me({type:Boolean})],zt.prototype,"open",void 0),zt=e([pe("chorus-help")],zt);const At={CC:"Soundbar",LF:"Front L",RF:"Front R",LR:"Rear L",RR:"Rear R",SW:"Sub"},Ct={CC:"var(--chorus-cc)",LF:"var(--chorus-front)",RF:"var(--chorus-front)",LR:"var(--chorus-rear)",RR:"var(--chorus-rear)",SW:"var(--chorus-sub)"};let Mt=class extends ce{constructor(){super(...arguments),this.narrow=!1,this._view="editor",this._loading=!0,this._help=!1,this._polling=!1}firstUpdated(){this._load()}connectedCallback(){super.connectedCallback(),this._pollTimer=window.setInterval(()=>{this._poll()},12e3)}disconnectedCallback(){super.disconnectedCallback(),this._pollTimer&&(window.clearInterval(this._pollTimer),this._pollTimer=void 0)}async _poll(){if(!this._polling&&this.hass){this._polling=!0;try{this._graph=await this.hass.connection.sendMessagePromise({type:"chorus/refresh"})}catch{}finally{this._polling=!1}}}async _load(e=!1){this._loading=!0,this._error=void 0;try{this._graph=await this.hass.connection.sendMessagePromise({type:e?"chorus/refresh":"chorus/bond_graph"})}catch(e){this._error=e?.message||e?.code||"unknown error"}finally{this._loading=!1}}render(){return B`
      ...
      <div class="card">
        <div class="rhead">
          <span class="ric ${this._roomTint(e)}" aria-hidden="true"
            >${Te(this._roomGlyphModel(e))}</span
          >
          <div class="rmeta">
    ...
    `}_entryRow(e){const t=e.ch?At[e.ch]??e.ch:"Speaker",r=e.ch?Ct[e.ch]??"var(--chorus-cc)":"",o=Ne(e.model);return B`
      <div class="member">
  ...
  `,e([me({attribute:!1})],Mt.prototype,"hass",void 0),e([me({attribute:!1})],Mt.prototype,"narrow",void 0),e([ge()],Mt.prototype,"_view",void 0),e([ge()],Mt.prototype,"_graph",void 0),e([ge()],Mt.prototype,"_error",void 0),e([ge()],Mt.prototype,"_loading",void 0),e([ge()],Mt.prototype,"_help",void 0),e([ge()],Mt.prototype,"_editRoom",void 0),Mt=e([pe("chorus-panel")],Mt);export{Mt as ChorusPanel};
