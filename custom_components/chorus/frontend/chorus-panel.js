...
`;let Jt=class extends pt{constructor(){super(...arguments),this._message="",this._visible=!1}show(t){this._clearTimer(),this._message=t,this._visible=!0,this._timer=window.setTimeout(()=>{this._visible=!1,this._timer=void 0},2700)}disconnectedCallback(){super.disconnectedCallback(),this._clearTimer()}_clearTimer(){void 0!==this._timer&&(window.clearTimeout(this._timer),this._timer=void 0)}render(){return this._message?I`
  ...
  `,t([gt()],Jt.prototype,"_message",void 0),t([gt()],Jt.prototype,"_visible",void 0),Jt=t([dt("chorus-toast")],Jt);const Yt={LF:"t-front",RF:"t-front",LR:"t-rear",RR:"t-rear",SW:"t-sub"};let Xt=class extends pt{constructor(){super(...arguments),this.narrow=!1,this._dirty=!1,this._applying=!1,this._rows=[]}willUpdate(t){(t.has("graph")&&!this._dirty||void 0===this._working)&&(this._working=structuredClone(Mt(this.graph)))}get _rooms(){return this._working??Mt(this.graph)}_room(){const t=this._rooms;if(this._selected){const e=t.find(t=>t.key===this._selected);if(e)return e}return this.narrow?void 0:t[0]}_plan(){return Qt(Ot(Mt(this.graph)),Ot(this._rooms))}_toast(t){const e=this.shadowRoot?.querySelector("chorus-toast");e?.show(t)}_assign(t,e,r){this._working=function(t,e,r,o){const s=Nt(t),i=Tt(s,e);if(!i||!i.ht)return s;const a=i.tray.findIndex(t=>t.uid===o);if(-1===a)return s;const[n]=i.tray.splice(a,1),c=i.ht.slots[r];return c&&i.tray.push(c),i.ht.slots[r]=n,i.tray.sort((t,e)=>t.name.localeCompare(e.name,void 0,{numeric:!0})),s}(this._rooms,t,e,r.uid),this._dirty=!0,this._picker=void 0,this._toast(`${r.name} → ${vt[e]}`)}_clear(t,e,r){this._working=function(t,e,r){const o=Nt(t),s=Tt(o,e);if(!s||!s.ht)return o;const i=s.ht.slots[r];return i?(s.ht.slots[r]=null,s.tray.push(i),s.tray.sort((t,e)=>t.name.localeCompare(e.name,void 0,{numeric:!0})),o):o}(this._rooms,t,e),this._dirty=!0,this._toast(`${r.name} removed from ${vt[e]}`)}_separate(t,e){this._working=function(t,e,r){const o=Nt(t),s=Tt(o,e);if(!s||r<0||r>=s.pairs.length)return o;const[i]=s.pairs.splice(r,1);for(const t of[i.L,i.R,i.sub])t&&s.tray.push(t);return s.tray.sort((t,e)=>t.name.localeCompare(e.name,void 0,{numeric:!0})),o}(this._rooms,t,e),this._dirty=!0,this._toast("Stereo pair separated")}_pickPairMember(t){if(!this._pairPick)return;const{roomKey:e,first:r}=this._pairPick;r?t.uid!==r&&(this._working=function(t,e,r,o){const s=Nt(t),i=Tt(s,e);if(!i||r===o)return s;const a=i.tray.findIndex(t=>t.uid===r),n=i.tray.findIndex(t=>t.uid===o);if(-1===a||-1===n)return s;const c=i.tray[a],p=i.tray[n];return i.tray=i.tray.filter(t=>t.uid!==r&&t.uid!==o),i.pairs.push({L:c,R:p,sub:null}),s}(this._rooms,e,r,t.uid),this._dirty=!0,this._pairPick=void 0,this._toast("Stereo pair created")):this._pairPick={roomKey:e,first:t.uid}}_discard(){this._working=structuredClone(Mt(this.graph)),this._dirty=!1,this._picker=void 0,this._toast("Changes discarded")}async _apply(){const t=this._plan();if(function(t){return 0===t.ops.length}(t)||this._applying)return;this._applying=!0,this._rows=t.rows,await function(t,e,r){const o=t=>t.map(t=>({summary:t.op.summary,status:t.status}));return Vt(t,e.lanes,{onUpdate:t=>r(o(t))}).then(t=>o(t))}(this.hass,t,t=>{this._rows=[...t]});const e=this._bondSignature(Ot(this._rooms)),r=await this._awaitConvergence(e),o=this._rows.filter(t=>"error"===t.status).length;this._applying=!1,this._dirty=!1,r?this.dispatchEvent(new CustomEvent("chorus-graph",{detail:r,bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("chorus-refresh",{bubbles:!0,composed:!0})),this._toast(o?`Applied with ${o} error${1===o?"":"s"}`:"Applied")}_bondSignature(t){return Object.keys(t).sort().map(e=>`${e}:${t[e].role}:${t[e].anchorUid}`).join(";")}async _awaitConvergence(t){let e;for(let r=0;r<5;r++){let r;try{r=await this.hass.connection.sendMessagePromise({type:"chorus/refresh"})}catch{return e}if(e=r,this._bondSignature(Ot(Mt(r)))===t)return r;await new Promise(t=>window.setTimeout(t,1500))}return e}_name(t){return t.name&&!/^RINCON_/i.test(t.name)?t.name:Pt(t.model)||"Speaker"}render(){const t=this._rooms;if(!t.length)return I`<div class="empty">No Sonos speakers discovered yet.</div>
    ...
    `}_pos(t,e,r){const o=e.slots[r],s=t.tray.some(t=>$t(r,t.model));return o?I`
      <div class="postile">
        <span class="badge ${Yt[r]}">${Et(o.model)}</span>
        <span class="pmeta">
          <b>${this._name(o)}</b>
    ...
    `:I`
        <button
          ...
          @click=${()=>s&&(this._picker={roomKey:t.key,ch:r})}
        >
