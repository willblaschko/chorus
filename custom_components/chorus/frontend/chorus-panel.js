...
`;let Je=class extends le{constructor(){super(...arguments),this._message="",this._visible=!1}show(e){this._clearTimer(),this._message=e,this._visible=!0,this._timer=window.setTimeout(()=>{this._visible=!1,this._timer=void 0},2700)}disconnectedCallback(){super.disconnectedCallback(),this._clearTimer()}_clearTimer(){void 0!==this._timer&&(window.clearTimeout(this._timer),this._timer=void 0)}render(){return this._message?I`
  ...
  `,e([ge({type:String})],et.prototype,"heading",void 0),e([ge({type:String})],et.prototype,"subheading",void 0),e([ge({attribute:!1})],et.prototype,"controls",void 0),e([ge({type:Boolean})],et.prototype,"open",void 0),et=e([pe("chorus-audio")],et);const tt=[{key:"bass",label:"Bass",group:"EQ"},{key:"treble",label:"Treble",group:"EQ"},{key:"loudness",label:"Loudness",group:"EQ",toggle:!0},{key:"sub_gain",label:"Sub level",group:"Surround & sub"},{key:"subwoofer_enabled",label:"Subwoofer",group:"Surround & sub",toggle:!0},{key:"surround_level",label:"Surround level",group:"Surround & sub"},{key:"surround_enabled",label:"Surround",group:"Surround & sub",toggle:!0},{key:"night_sound",label:"Night sound",group:"TV audio",toggle:!0},{key:"speech_enhancement",label:"Speech enhancement",group:"TV audio",toggle:!0},{key:"audio_delay",label:"Audio delay",group:"TV audio"},{key:"crossfade",label:"Crossfade",group:"Playback",toggle:!0},{key:"balance",label:"Balance",group:"Playback"}],rt={LF:"t-front",RF:"t-front",LR:"t-rear",RR:"t-rear",SW:"t-sub"};let ot=class extends le{constructor(){super(...arguments),this.narrow=!1,this._dirty=!1,this._applying=!1,this._rows=[],this._onMenuSelect=e=>{const t=this._menu;this._menu=void 0,t?.onSelect(e.detail)},this._onAudioChange=e=>{const{id:t,value:r}=e.detail;"boolean"==typeof r?this.hass.callService("switch",r?"turn_on":"turn_off",{entity_id:t}):this.hass.callService("number","set_value",{entity_id:t,value:r}),this._audio&&(this._audio={...this._audio,controls:this._audio.controls.map(e=>e.id===t?{...e,value:r}:e)})}}willUpdate(e){(e.has("graph")&&!this._dirty||void 0===this._working)&&(this._working=structuredClone(Me(this.graph)))}get _rooms(){return this._working??Me(this.graph)}_room(){const e=this._rooms;if(this._selected){const t=e.find(e=>e.key===this._selected);if(t)return t}return this.narrow?void 0:e[0]}_plan(){return Ye(Ue(Me(this.graph)),Ue(this._rooms))}_toast(e){const t=this.shadowRoot?.querySelector("chorus-toast");t?.show(e)}_assign(e,t,r){this._working=function(e,t,r,o){const s=Te(e),i=Ne(s,t);if(!i||!i.ht)return s;const a=i.tray.findIndex(e=>e.uid===o);if(-1===a)return s;const[n]=i.tray.splice(a,1),c=i.ht.slots[r];return c&&i.tray.push(c),i.ht.slots[r]=n,i.tray.sort((e,t)=>e.name.localeCompare(t.name,void 0,{numeric:!0})),s}(this._rooms,e,t,r.uid),this._dirty=!0,this._picker=void 0,this._toast(`${this._name(r)} → ${fe[t]}`)}_canDrop(e,t){return!!this._drag&&this._drag.roomKey===e.key&&$e(t,this._drag.model)}_dropOnChannel(e,t){if(!this._canDrop(e,t))return;const r=e.tray.find(e=>e.uid===this._drag.uid);this._drag=void 0,r&&this._assign(e.key,t,r)}_onDragOver(e,t,r){this._canDrop(t,r)&&(e.preventDefault(),e.currentTarget.classList.add("over"))}_onDrop(e,t,r){e.preventDefault(),e.currentTarget.classList.remove("over"),this._dropOnChannel(t,r)}_clear(e,t,r){this._working=He(this._rooms,e,t),this._dirty=!0,this._toast(`${r.name} removed from ${fe[t]}`)}_separate(e,t){this._working=function(e,t,r){const o=Te(e),s=Ne(o,t);if(!s||r<0||r>=s.pairs.length)return o;const[i]=s.pairs.splice(r,1);for(const e of[i.L,i.R,i.sub])e&&s.tray.push(e);return s.tray.sort((e,t)=>e.name.localeCompare(t.name,void 0,{numeric:!0})),o}(this._rooms,e,t),this._dirty=!0,this._toast("Stereo pair separated")}_pickPairMember(e){if(!this._pairPick)return;const{roomKey:t,first:r}=this._pairPick;r?e.uid!==r&&(this._working=function(e,t,r,o){const s=Te(e),i=Ne(s,t);if(!i||r===o)return s;const a=i.tray.findIndex(e=>e.uid===r),n=i.tray.findIndex(e=>e.uid===o);if(-1===a||-1===n)return s;const c=i.tray[a],l=i.tray[n];return i.tray=i.tray.filter(e=>e.uid!==r&&e.uid!==o),i.pairs.push({L:c,R:l,sub:null}),s}(this._rooms,t,r,e.uid),this._dirty=!0,this._pairPick=void 0,this._toast("Stereo pair created")):this._pairPick={roomKey:t,first:e.uid}}_openRoomMenu(e){const t=[];e.ht&&(t.push({id:"audio",label:"Audio settings"}),t.push({id:"dissolve",label:"Separate home theater",danger:!0})),t.length&&(this._menu={heading:e.name,items:t,onSelect:t=>{"audio"===t?this._openAudio(e.ht.bar.name):"dissolve"===t&&(this._working=function(e,t){const r=Ne(e,t);if(!r?.ht)return Te(e);let o=Te(e);for(const e of be)o=He(o,t,e);return o}(this._rooms,e.key),this._dirty=!0,this._toast("Home theater separated"))}})}_openPairMenu(e,t){this._menu={heading:"Stereo pair",items:[{id:"audio",label:"Audio settings"},{id:"swap",label:"Swap L / R"},{id:"separate",label:"Separate pair",danger:!0}],onSelect:r=>{"audio"===r?this._openAudio(e.pairs[t]?.L?.name??e.name):"swap"===r?(this._working=function(e,t,r){const o=Te(e),s=Ne(o,t);if(!s||r<0||r>=s.pairs.length)return o;const i=s.pairs[r];return[i.L,i.R]=[i.R,i.L],o}(this._rooms,e.key,t),this._dirty=!0,this._toast("Swapped L / R")):"separate"===r&&this._separate(e.key,t)}}}_openSpeakerMenu(e){this._menu={heading:this._name(e),items:[{id:"identify",label:"Identify"}],onSelect:t=>{"identify"===t&&this._toast(`Chiming on ${this._name(e)}`)}}}_openAudio(e){const t=(e=>e.toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,""))(e),r=[];for(const e of tt){const o=`${e.toggle?"switch":"number"}.${t}_${e.key}`,s=this.hass?.states?.[o];if(s&&"unavailable"!==s.state&&"unknown"!==s.state)if(e.toggle)r.push({id:o,kind:"toggle",label:e.label,group:e.group,value:"on"===s.state});else{const t=s.attributes;r.push({id:o,kind:"slider",label:e.label,group:e.group,value:Number(s.state),min:t.min??0,max:t.max??100,step:t.step??1})}}r.length?this._audio={heading:`${e} · Audio`,controls:r}:this._toast("No audio settings available for this speaker")}_dots(e){return I`<button
    ...
    >
      ⋯
    </button>`}_discard(){this._working=structuredClone(Me(this.graph)),this._dirty=!1,this._picker=void 0,this._toast("Changes discarded")}async _apply(){const e=this._plan();if(function(e){return 0===e.ops.length}(e)||this._applying)return;this._applying=!0,this._rows=e.rows,await function(e,t,r){const o=e=>e.map(e=>({summary:e.op.summary,status:e.status}));return Qe(e,t.lanes,{onUpdate:e=>r(o(e))}).then(e=>o(e))}(this.hass,e,e=>{this._rows=[...e]});const t=this._bondSignature(Ue(this._rooms)),r=await this._awaitConvergence(t),o=this._rows.filter(e=>"error"===e.status).length;this._applying=!1,this._dirty=!1,r?this.dispatchEvent(new CustomEvent("chorus-graph",{detail:r,bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("chorus-refresh",{bubbles:!0,composed:!0})),this._toast(o?`Applied with ${o} error${1===o?"":"s"}`:"Applied")}_bondSignature(e){return Object.keys(e).sort().map(t=>`${t}:${e[t].role}:${e[t].anchorUid}`).join(";")}async _awaitConvergence(e){let t;for(let r=0;r<5;r++){let r;try{r=await this.hass.connection.sendMessagePromise({type:"chorus/refresh"})}catch{return t}if(t=r,this._bondSignature(Ue(Me(r)))===e)return r;await new Promise(e=>window.setTimeout(e,1500))}return t}_name(e){return e.name&&!/^RINCON_/i.test(e.name)?e.name:Le(e.model)||"Speaker"}render(){const e=this._rooms;if(!e.length)return I`<div class="empty">No Sonos speakers discovered yet.</div>
    ...
    `}_pos(e,t,r){const o=t.slots[r],s=e.tray.some(e=>$e(r,e.model));if(!o){const t=()=>{s&&(this._picker={roomKey:e.key,ch:r})};return I`
        <div
          ...
          role=${s?"button":q}
          tabindex=${s?"0":q}
          title=${s?`Add ${fe[r]}`:"No eligible speaker in this room"}
          @click=${t}
    ...
    `}_pickerOverlay(){if(!this._picker)return q;const{roomKey:e,ch:t}=this._picker,r=this._rooms.find(t=>t.key===e),o=(r?.tray??[]).filter(e=>$e(t,e.model));return I`
      <div class="backdrop" @click=${()=>this._picker=void 0}>
        <div class="sheet" @click=${e=>e.stopPropagation()}>
          <div class="sheet-h">Add ${fe[t]}</div>
          ${o.length?o.map(r=>I`
  ...
  `,e([ge({attribute:!1})],ot.prototype,"hass",void 0),e([ge({attribute:!1})],ot.prototype,"graph",void 0),e([ge({type:Boolean})],ot.prototype,"narrow",void 0),e([me()],ot.prototype,"_selected",void 0),e([me()],ot.prototype,"_working",void 0),e([me()],ot.prototype,"_dirty",void 0),e([me()],ot.prototype,"_applying",void 0),e([me()],ot.prototype,"_rows",void 0),e([me()],ot.prototype,"_picker",void 0),e([me()],ot.prototype,"_pairPick",void 0),e([me()],ot.prototype,"_menu",void 0),e([me()],ot.prototype,"_audio",void 0),ot=e([pe("chorus-editor")],ot);const st={home_theater:"Home theater",stereo_pair:"Stereo pair",standalone:"Standalone"},it={CC:"Center",LF:"Front L",RF:"Front R",LR:"Rear L",RR:"Rear R",SW:"Sub"},at={CC:"var(--chorus-cc)",LF:"var(--chorus-front)",RF:"var(--chorus-front)",LR:"var(--chorus-rear)",RR:"var(--chorus-rear)",SW:"var(--chorus-sub)"},nt={home_theater:0,stereo_pair:1,standalone:2};let ct=class extends le{constructor(){super(...arguments),this.narrow=!1,this._view="editor",this._loading=!0}firstUpdated(){this._load()}async _load(e=!1){this._loading=!0,this._error=void 0;try{this._graph=await this.hass.connection.sendMessagePromise({type:e?"chorus/refresh":"chorus/bond_graph"})}catch(e){this._error=e?.message||e?.code||"unknown error"}finally{this._loading=!1}}render(){return I`
      <div class="wrap">
        ${this._header()}
