...
`;let ut=class extends le{constructor(){super(...arguments),this._message="",this._visible=!1}show(e){this._clearTimer(),this._message=e,this._visible=!0,this._timer=window.setTimeout(()=>{this._visible=!1,this._timer=void 0},2700)}disconnectedCallback(){super.disconnectedCallback(),this._clearTimer()}_clearTimer(){void 0!==this._timer&&(window.clearTimeout(this._timer),this._timer=void 0)}render(){return this._message?I`
  ...
  `,e([me({type:String})],gt.prototype,"heading",void 0),e([me({type:String})],gt.prototype,"subheading",void 0),e([me({attribute:!1})],gt.prototype,"controls",void 0),e([me({type:Boolean})],gt.prototype,"open",void 0),gt=e([pe("chorus-audio")],gt);const bt=[{key:"bass",label:"Bass",group:"EQ"},{key:"treble",label:"Treble",group:"EQ"},{key:"loudness",label:"Loudness",group:"EQ",toggle:!0},{key:"sub_gain",label:"Sub level",group:"Surround & sub"},{key:"subwoofer_enabled",label:"Subwoofer",group:"Surround & sub",toggle:!0},{key:"surround_level",label:"Surround level",group:"Surround & sub"},{key:"surround_enabled",label:"Surround",group:"Surround & sub",toggle:!0},{key:"night_sound",label:"Night sound",group:"TV audio",toggle:!0},{key:"speech_enhancement",label:"Speech enhancement",group:"TV audio",toggle:!0},{key:"audio_delay",label:"Audio delay",group:"TV audio"},{key:"crossfade",label:"Crossfade",group:"Playback",toggle:!0},{key:"balance",label:"Balance",group:"Playback"}],vt={LF:"t-front",RF:"t-front",LR:"t-rear",RR:"t-rear",SW:"t-sub"};let ft=class extends le{constructor(){super(...arguments),this.narrow=!1,this._dirty=!1,this._applying=!1,this._rows=[],this._settleView=null,this._releasedUids=[],this._settleTimedOut=!1,this._onMenuSelect=e=>{const t=this._menu;this._menu=void 0,t?.onSelect(e.detail)},this._onAudioChange=e=>{const{id:t,value:r}=e.detail;"boolean"==typeof r?this.hass.callService("switch",r?"turn_on":"turn_off",{entity_id:t}):this.hass.callService("number","set_value",{entity_id:t,value:r}),this._audio&&(this._audio={...this._audio,controls:this._audio.controls.map(e=>e.id===t?{...e,value:r}:e)})}}willUpdate(e){(e.has("graph")&&!this._dirty||void 0===this._working)&&(this._working=structuredClone(Pe(this.graph)))}get _rooms(){return this._working??Pe(this.graph)}_room(){const e=this._rooms.filter(e=>e.key!==Re);if(this._selected){const t=e.find(e=>e.key===this._selected);if(t)return t}return this.narrow?void 0:e[0]}_availableSubs(){return this._rooms.find(e=>e.key===Re)?.tray??[]}_plan(){return it(De(Pe(this.graph)),De(this._rooms))}_toast(e){const t=this.shadowRoot?.querySelector("chorus-toast");t?.show(e)}_assign(e,t,r,o){this._working=function(e,t,r,o,s){const i=je(e),a=He(i,t),n=We(a,r);if(!a||!n)return i;const c=a.tray.findIndex(e=>e.uid===s);if(-1===c)return i;const[l]=a.tray.splice(c,1),d=n.slots[o];return d&&qe(i,a,o,d),n.slots[o]=l,a.tray.sort(Be),i}(this._rooms,e,t,r,o.uid),this._dirty=!0,this._picker=void 0,this._toast(`${this._name(o)} → ${ve[r]}`)}_assignSub(e,t,r){const o=this._availableSubs().find(e=>e.uid===r);this._working=function(e,t,r,o){const s=je(e),i=He(s,t),a=We(i,r);if(!i||!a)return s;let n;const c=s.find(e=>e.key===Re);if(c){const e=c.tray.findIndex(e=>e.uid===o);e>=0&&(n=c.tray.splice(e,1)[0])}if(!n)e:for(const e of s)for(const t of e.sets)if(t.slots.SW?.uid===o){n=t.slots.SW,delete t.slots.SW;break e}if(!n)return s;const l=a.slots.SW;return l&&Ve(s,l),a.slots.SW=n,Ie(s)}(this._rooms,e,t,r),this._dirty=!0,this._picker=void 0,this._toast(o?`${this._name(o)} → ${ve.SW}`:"Sub added")}_canDrop(e,t){return!!this._drag&&(this._drag.roomKey===Re?"SW"===t&&ke("SW",this._drag.model):this._drag.roomKey===e.key&&ke(t,this._drag.model))}_dropOnChannel(e,t,r){if(!this._canDrop(e,r))return;const o=this._drag;if(this._drag=void 0,o.roomKey===Re)this._assignSub(e.key,t,o.uid);else{const s=e.tray.find(e=>e.uid===o.uid);s&&this._assign(e.key,t,r,s)}}_onDragOver(e,t,r){this._canDrop(t,r)&&(e.preventDefault(),e.currentTarget.classList.add("over"))}_onDrop(e,t,r,o){e.preventDefault(),e.currentTarget.classList.remove("over"),this._dropOnChannel(t,r,o)}_clear(e,t,r,o){this._working=Qe(this._rooms,e,t,r),this._dirty=!0,this._toast(`${o.name} removed from ${ve[r]}`)}_separate(e,t){this._working=function(e,t,r){const o=je(e),s=He(o,t);if(!s)return o;const i=s.sets.findIndex(e=>e.id===r);if(-1===i)return o;const[a]=s.sets.splice(i,1);return Ke(s,a.primary),a.slots.RF&&Ke(s,a.slots.RF),a.slots.SW&&Ve(o,a.slots.SW),Ie(o)}(this._rooms,e,t),this._dirty=!0,this._toast("Stereo pair separated")}_pickPairMember(e){if(!this._pairPick)return;const{roomKey:t,first:r}=this._pairPick;r?e.uid!==r&&(this._working=function(e,t,r,o){const s=je(e),i=He(s,t);if(!i||r===o)return s;const a=i.tray.findIndex(e=>e.uid===r),n=i.tray.findIndex(e=>e.uid===o);if(-1===a||-1===n)return s;const c=i.tray[a],l=i.tray[n];return i.tray=i.tray.filter(e=>e.uid!==r&&e.uid!==o),i.sets.push({id:c.uid,primary:c,slots:{RF:l}}),s}(this._rooms,t,r,e.uid),this._dirty=!0,this._pairPick=void 0,this._toast("Stereo pair created")):this._pairPick={roomKey:t,first:e.uid}}_openRoomMenu(e,t){this._menu={heading:e.name,items:[{id:"audio",label:"Audio settings"},{id:"dissolve",label:"Separate home theater",danger:!0}],onSelect:r=>{"audio"===r?this._openAudio(t.primary.name):"dissolve"===r&&(this._working=function(e,t,r){const o=je(e),s=He(o,t);if(!s)return o;const i=s.sets.findIndex(e=>e.id===r);if(-1===i)return o;const[a]=s.sets.splice(i,1);for(const e of be){const t=a.slots[e];t&&qe(o,s,e,t)}return Ke(s,a.primary),Ie(o)}(this._rooms,e.key,t.id),this._dirty=!0,this._toast("Home theater separated"))}}}_openPairMenu(e,t){const r=!!t.slots.SW?[{id:"audio",label:"Audio settings"},{id:"removesub",label:"Remove sub"}]:[{id:"audio",label:"Audio settings"},{id:"addsub",label:"Add a sub…"},{id:"swap",label:"Swap L / R"},{id:"separate",label:"Separate pair",danger:!0}];this._menu={heading:"Stereo pair",items:r,onSelect:r=>{"audio"===r?this._openAudio(t.primary.name):"addsub"===r?this._availableSubs().length?this._picker={roomKey:e.key,setId:t.id,ch:"SW"}:this._toast("No available sub"):"removesub"===r?(this._working=Qe(this._rooms,e.key,t.id,"SW"),this._dirty=!0,this._toast("Sub removed")):"swap"===r?(this._working=function(e,t,r){const o=je(e),s=We(He(o,t),r);if(!s||!s.slots.RF)return o;const i=s.primary;return s.primary=s.slots.RF,s.slots.RF=i,s.id=s.primary.uid,o}(this._rooms,e.key,t.id),this._dirty=!0,this._toast("Swapped L / R")):"separate"===r&&this._separate(e.key,t.id)}}}_openSpeakerMenu(e){this._menu={heading:this._name(e),items:[{id:"identify",label:"Identify"},{id:"rename",label:"Rename…"},{id:"move",label:"Move to another room…"}],onSelect:t=>{"identify"===t?this._toast(`Chiming on ${this._name(e)}`):"rename"===t?this._renameFor={uid:e.uid,current:this._name(e)}:"move"===t&&(this._movePick=e.uid)}}}_doRename(){const e=this.shadowRoot?.querySelector(".rename-input"),t=e?.value.trim(),r=this._renameFor;this._renameFor=void 0,r&&t&&t!==r.current&&(this.hass.callService("chorus","rename",{speaker:r.uid,name:t}),this._toast(`Renamed to ${t}`),this.dispatchEvent(new CustomEvent("chorus-refresh",{bubbles:!0,composed:!0})))}_renameOverlay(){return this._renameFor?I`
    ...
    `}_htSet(e){return e.sets.find(e=>"home_theater"===Se(e))}_pairSets(e){return e.sets.filter(e=>"stereo_pair"===Se(e))}_speakerSets(e){return e.sets.filter(e=>"speaker"===Se(e))}_speakerSetCard(e){const t=e.slots.SW??null;return I`
      <div class="paircard">
        <span class="badge orb t-front">${Le(e.primary.model)}</span>
        <div class="pc-meta">
          <b>${this._name(e.primary)}</b>
          <span>${Ue(e.primary.model)}${t?" · with sub":""}</span>
        </div>
        ${t?I`<span class="pc-sub"><span class="pc-sub-ic">${Le(t.model)}</span> Sub · ${t.name}</span>`:q}
      </div>
    ...
    `}_pos(e,t,r){const o=t.slots[r],s="SW"===r?this._availableSubs().length>0:e.tray.some(e=>ke(r,e.model));if(!o){const o=()=>{s&&(this._picker={roomKey:e.key,setId:t.id,ch:r})};return I`
      ...
      <div
        ...
        @drop=${o=>this._onDrop(o,e,t.id,r)}
      >
        <span class="badge ${vt[r]}">${Le(o.model)}</span>
        <span class="pmeta">
          <b>${this._name(o)}</b>
