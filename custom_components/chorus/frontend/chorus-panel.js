...
`;let _t=class extends de{constructor(){super(...arguments),this._message="",this._visible=!1}show(e){this._clearTimer(),this._message=e,this._visible=!0,this._timer=window.setTimeout(()=>{this._visible=!1,this._timer=void 0},2700)}disconnectedCallback(){super.disconnectedCallback(),this._clearTimer()}_clearTimer(){void 0!==this._timer&&(window.clearTimeout(this._timer),this._timer=void 0)}render(){return this._message?B`
  ...
  `,e([me({type:String})],kt.prototype,"heading",void 0),e([me({type:String})],kt.prototype,"subheading",void 0),e([me({attribute:!1})],kt.prototype,"controls",void 0),e([me({type:Boolean})],kt.prototype,"open",void 0),kt=e([pe("chorus-audio")],kt);const $t=[{key:"bass",label:"Bass",group:"EQ"},{key:"treble",label:"Treble",group:"EQ"},{key:"loudness",label:"Loudness",group:"EQ",toggle:!0},{key:"sub_gain",label:"Sub level",group:"Surround & sub"},{key:"subwoofer_enabled",label:"Subwoofer",group:"Surround & sub",toggle:!0},{key:"surround_level",label:"Surround level",group:"Surround & sub"},{key:"surround_enabled",label:"Surround",group:"Surround & sub",toggle:!0},{key:"night_sound",label:"Night sound",group:"TV audio",toggle:!0},{key:"speech_enhancement",label:"Speech enhancement",group:"TV audio",toggle:!0},{key:"audio_delay",label:"Audio delay",group:"TV audio"},{key:"crossfade",label:"Crossfade",group:"Playback",toggle:!0},{key:"balance",label:"Balance",group:"Playback"}],St="chorus:fixed_output",zt="chorus:volume",Ct={LF:"t-front",RF:"t-front",LR:"t-rear",RR:"t-rear",SW:"t-sub"};let At=class extends de{constructor(){super(...arguments),this.narrow=!1,this._dirty=!1,this._applying=!1,this._lastFailed=0,this._rows=[],this._settleView=null,this._releasedUids=[],this._settleTimedOut=!1,this._vol={},this._syncOverlayCentre=()=>{const e=this.getBoundingClientRect();e.width&&this.style.setProperty("--chorus-bar-left",`${Math.round(e.left+e.width/2)}px`)},this._onMenuSelect=e=>{const t=this._menu;this._menu=void 0,t?.onSelect(e.detail)},this._onAudioChange=e=>{const{id:t,value:r}=e.detail;if(t.startsWith(`${zt}:`))this._setVolume(t.slice(14),Number(r));else if(t.startsWith(`${St}:`)){const e=t.slice(20);this.hass.callService("chorus","set_fixed_output",{speaker:e,enabled:!!r})}else"boolean"==typeof r?this.hass.callService("switch",r?"turn_on":"turn_off",{entity_id:t}):this.hass.callService("number","set_value",{entity_id:t,value:r});this._audio&&(this._audio={...this._audio,controls:this._audio.controls.map(e=>e.id===t?{...e,value:r}:e)})}}connectedCallback(){super.connectedCallback(),this._syncOverlayCentre(),this._ro=new ResizeObserver(()=>this._syncOverlayCentre()),this._ro.observe(this),window.addEventListener("resize",this._syncOverlayCentre)}disconnectedCallback(){this._ro?.disconnect(),window.removeEventListener("resize",this._syncOverlayCentre),super.disconnectedCallback()}willUpdate(e){if((e.has("graph")&&!this._dirty||void 0===this._working)&&(this._working=Ye(Te(this.graph))),e.has("graph")&&(this._vol={}),e.has("selectRoom")&&(this._selected=this.selectRoom),e.has("pendingSub")&&this.pendingSub){const{subUid:e,roomKey:t,kind:r,targetId:o}=this.pendingSub;this._working="speaker"===r?Je(this._rooms,t,o,e):Ze(this._rooms,t,o,e),this._dirty=!0,this.dispatchEvent(new CustomEvent("sub-staged",{bubbles:!0,composed:!0}))}}get _rooms(){return this._working??Te(this.graph)}_room(){const e=this._rooms.filter(e=>e.key!==Pe);if(this._selected){const t=e.find(e=>e.key===this._selected);if(t)return t}return this.narrow?void 0:e[0]}_availableSubs(){return this._rooms.find(e=>e.key===Pe)?.tray??[]}_plan(){return ht(We(Te(this.graph)),We(this._rooms))}_toast(e){const t=this.shadowRoot?.querySelector("chorus-toast");t?.show(e)}_assign(e,t,r,o){this._working=function(e,t,r,o,s){const i=De(e),a=Ie(i,t),n=je(a,r);if(!a||!n)return i;const l=a.tray.findIndex(e=>e.uid===s);if(-1===l)return i;const[d]=a.tray.splice(l,1),c=n.slots[o];return c&&Qe(i,a,o,c),n.slots[o]=d,a.tray.sort(He),i}(this._rooms,e,t,r,o.uid),this._dirty=!0,this._picker=void 0,this._toast(`${this._name(o)} → ${ve[r]}`)}_assignSub(e,t,r){const o=this._availableSubs().find(e=>e.uid===r);this._working=Ze(this._rooms,e,t,r),this._dirty=!0,this._picker=void 0,this._toast(o?`${this._name(o)} → ${ve.SW}`:"Sub added")}_canDrop(e,t){return!!this._drag&&(this._drag.roomKey===Pe?"SW"===t&&Se("SW",this._drag.model):this._drag.roomKey===e.key&&Se(t,this._drag.model))}_dropOnChannel(e,t,r){if(!this._canDrop(e,r))return;const o=this._drag;if(this._drag=void 0,o.roomKey===Pe)this._assignSub(e.key,t,o.uid);else{const s=e.tray.find(e=>e.uid===o.uid);s&&this._assign(e.key,t,r,s)}}_onDragOver(e,t,r){this._canDrop(t,r)&&(e.preventDefault(),e.currentTarget.classList.add("over"))}_onDrop(e,t,r,o){e.preventDefault(),e.currentTarget.classList.remove("over"),this._dropOnChannel(t,r,o)}_clear(e,t,r,o){this._working=Xe(this._rooms,e,t,r),this._dirty=!0,this._toast(`${o.name} removed from ${ve[r]}`)}_separate(e,t){this._working=et(this._rooms,e,t),this._dirty=!0,this._toast("Stereo pair separated")}_pickPairMember(e){if(!this._pairPick)return;const{roomKey:t,first:r}=this._pairPick;r?e.uid!==r&&(this._working=function(e,t,r,o){const s=De(e),i=Ie(s,t);if(!i||r===o)return s;const a=i.tray.findIndex(e=>e.uid===r),n=i.tray.findIndex(e=>e.uid===o);if(-1===a||-1===n)return s;const l=i.tray[a],d=i.tray[n];return i.tray=i.tray.filter(e=>e.uid!==r&&e.uid!==o),i.sets.push({id:l.uid,name:qe(i),volume:l.volume??null,primary:l,slots:{RF:d}}),s}(this._rooms,t,r,e.uid),this._dirty=!0,this._pairPick=void 0,this._toast("Stereo pair created")):this._pairPick={roomKey:t,first:e.uid}}_openRoomMenu(e,t){this._menu={heading:e.name,items:[{id:"audio",label:"Audio settings"},{id:"dissolve",label:"Separate home theater",danger:!0}],onSelect:r=>{"audio"===r?this._openAudio(this._setName(t),t.primary.uid):"dissolve"===r&&(this._working=function(e,t,r){const o=De(e),s=Ie(o,t);if(!s)return o;const i=s.sets.findIndex(e=>e.id===r);if(-1===i)return o;const[a]=s.sets.splice(i,1);for(const e of fe){const t=a.slots[e];t&&Qe(o,s,e,t)}return Ve(s,a.primary),Be(o)}(this._rooms,e.key,t.id),this._dirty=!0,this._toast("Home theater separated"))}}}_openPairMenu(e,t){const r=!!t.slots.SW?[{id:"audio",label:"Audio settings"},{id:"rename",label:"Rename"},{id:"removesub",label:"Remove sub"}]:[{id:"audio",label:"Audio settings"},{id:"rename",label:"Rename"},{id:"addsub",label:"Add a sub"},{id:"swap",label:"Swap L / R"},{id:"separate",label:"Separate pair",danger:!0}];this._menu={heading:"Stereo pair",items:r,onSelect:r=>{"audio"===r?this._openAudio(this._setName(t),t.primary.uid):"rename"===r?this._renameFor={uid:t.primary.uid,current:this._setName(t)}:"addsub"===r?this._availableSubs().length?this._picker={roomKey:e.key,setId:t.id,ch:"SW"}:this._toast("No available sub"):"removesub"===r?(this._working=Xe(this._rooms,e.key,t.id,"SW"),this._dirty=!0,this._toast("Sub removed")):"swap"===r?(this._working=function(e,t,r){const o=De(e),s=je(Ie(o,t),r);if(!s||!s.slots.RF)return o;const i=s.primary;return s.primary=s.slots.RF,s.slots.RF=i,s.id=s.primary.uid,o}(this._rooms,e.key,t.id),this._dirty=!0,this._toast("Swapped L / R")):"separate"===r&&this._separate(e.key,t.id)}}}_openSpeakerMenu(e,t){const r=[{id:"identify",label:"Identify"},{id:"audio",label:"Audio settings"}];!we(e.model)&&this._availableSubs().length>0&&r.push({id:"addsub",label:"Add a sub"}),r.push({id:"rename",label:"Rename"},{id:"move",label:"Move to another room"}),this._menu={heading:this._name(e),items:r,onSelect:r=>{if("identify"===r)this._identify(e);else if("audio"===r)this._openAudio(this._name(e),e.uid);else if("addsub"===r){const r=this._availableSubs()[0];r&&(this._working=Je(this._rooms,t,e.uid,r.uid),this._dirty=!0,this._toast(`${this._name(r)} → ${ve.SW}`))}else"rename"===r?this._renameFor={uid:e.uid,current:this._name(e)}:"move"===r&&(this._movePick=e.uid)}}}_openSpeakerSetMenu(e,t){this._menu={heading:this._setName(t),items:[{id:"audio",label:"Audio settings"},{id:"removesub",label:"Remove sub"}],onSelect:r=>{"audio"===r?this._openAudio(this._setName(t),t.primary.uid):"removesub"===r&&(this._working=et(this._rooms,e.key,t.id),this._dirty=!0,this._toast("Sub removed"))}}}_doRename(){const e=this.shadowRoot?.querySelector(".rename-input"),t=e?.value.trim(),r=this._renameFor;this._renameFor=void 0,r&&t&&t!==r.current&&(this._working=function(e,t,r){const o=De(e);for(const e of o){for(const s of e.tray)if(s.uid===t)return s.name=r,o;for(const s of e.sets){if(s.primary.uid===t)return s.name=r,o;for(const e of fe){const i=s.slots[e];if(i?.uid===t)return s.name=r,o}}}return o}(this._rooms,r.uid,t),this._dirty=!0,this._toast(`Rename to ${t}`))}_renameOverlay(){return this._renameFor?B`
    ...
    `}_roomSummary(e){const t=[],r=this._htSet(e);if(r){const e=fe.filter(e=>"SW"!==e&&r.slots[e]).length;t.push(`Home theater · ${e}.${r.slots.SW?"1":"0"}`)}const o=this._pairSets(e).length;o&&t.push(1===o?"Stereo pair":`${o} pairs`);const s=e.tray.length;return s&&!r&&t.push(1===s?"1 speaker":`${s} speakers`),t.join(" · ")||"No speakers"}_detail(e){const t=this._htSet(e),r=this._pairSets(e),o=this._speakerSets(e);return B`
